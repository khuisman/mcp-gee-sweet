...
- ~~**Update `decision-fork.md`**~~ ✓ — removed stale "What This Project Has" section; added date + snapshot commit header to all four decision docs; ADR convention established (point-in-time, snapshot commit link).
