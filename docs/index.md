...
|---|---|---|---|
| Sheets | 35 tools — read/write, formulas, structure, formatting, charts, raw `batch_update` passthrough | 6 tools (Developer Preview) | [taylorwilsdon/google_workspace_mcp](https://github.com/taylorwilsdon/google_workspace_mcp) (12), [a-bonus/google-docs-mcp](https://github.com/a-bonus/google-docs-mcp) (~44, incl. comments/conditional formatting/protected ranges we don't have yet) |
| Docs | 34 tools — HTML + Markdown input, Markdown export, AST-based theming (`apply_theme`, named styles), structural table editing | 2 tools (Developer Preview) | taylorwilsdon (18), [piotr-agier/google-drive-mcp](https://github.com/piotr-agier/google-drive-mcp) (~17, incl. footnotes/multi-tab we don't have) |
| Drive | 38 tools | 8 tools | Several — piotr-agier and others cover a similar range |
| Calendar | 17 tools | 9 tools | Several |
...
Known gaps found while researching this comparison (comments, conditional formatting, protected ranges, multi-tab Docs, and more) are tracked as candidates in the [roadmap](roadmap.md), not silently ignored.
...
- [Tools](tools.md) — the full tool reference, grouped by domain
