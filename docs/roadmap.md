...
- [x] Docs version switcher never renders and each release's `mike deploy` overwrites the previous version instead of versioning alongside it — the `latest`/`develop` split from #267 isn't actually working (PR #668) ([#667](https://github.com/khuisman/mcp-gee-sweet/issues/667))
