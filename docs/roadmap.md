...
- [ ] Decision needed: should `report_progress`'s structured `progress`/`total` fields carry byte data, not just the message text? (PR #739 follow-up) ([#741](https://github.com/khuisman/mcp-gee-sweet/issues/741))
