...
An MCP server that gives AI clients reliable, direct access to Google Workspace — Sheets, Drive, Docs, and Calendar. 90 tools across four domains.
...
- [Tools](https://khuisman.github.io/mcp-gee-sweet/latest/tools/) — full tool reference (90 tools)
